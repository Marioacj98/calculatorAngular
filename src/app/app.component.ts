...
/* Función para abstraer el número */
  ...
  /* Función para validar los números decimales */
  decimal() {
  ...
  /* Función para escoger el operador necesario */
  ...
  /* Función para realizar la operación escogida */
  public realizarOperacion(op: string) {
    if (this.numero1 === null) {
      ...
      if (
        ...
        const resultado = this.operacion(
          this.signo,
          Number(this.valor.substring(String(this.numero1).length + 1))
        );
